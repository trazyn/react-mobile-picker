        ...
        switch (name) {
            ...
            case 'city':
                newState = {
                    optionGroups: {
                        ...this.state.optionGroups,
                        district: value.children,
                    },
                    valueGroups: {
                        ...this.state.valueGroups,
                        district: value.children[0],
                    }
                };
                break;
        }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (defaultValue) {
            this.setState({
                ...
                optionGroups: {
                    ...this.state.optionGroups,
                    city: defaultValue.province.children,
                    district: defaultValue.city.children,
                },
                valueGroups: defaultValue,
            });
        }
    }
